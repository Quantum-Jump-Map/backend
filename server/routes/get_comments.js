...
router.get('/level4', get_all_level1);
router.get('/level4', get_all_level2);
router.get('/level4', get_all_level3);
router.get('/level4', get_all_level4);
router.get('/level4', get_all_level5);
